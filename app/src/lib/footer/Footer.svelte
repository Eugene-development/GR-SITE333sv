...
<div class=" px-12 py-16 bg-gray-50" id="anchor6">
    <div class="grid grid-cols-1 gap-24  xl:grid-cols-4">
        <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
            <img class="h-16" src="/Logo/Logo_shir_6.svg" alt="Tuple">
        </div>
        <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1 hidden xl:block">
            <img class="h-16" src="/Logo/Logo_shir_6.svg" alt="Tuple">
        </div>
        <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1 hidden xl:block">
            <img class="h-16" src="/Logo/Logo_shir_6.svg" alt="Tuple">
        </div>
        <div class="col-span-1 flex justify-center md:col-span-3 lg:col-span-1 hidden xl:block">
            <img class="h-16" src="/Logo/Logo_shir_6.svg" alt="Tuple">
        </div>
    </div>
</div>
                ...
                <div class="md:grid md:grid-cols-1">
                    <div>
                        ...
                        <div class="mt-4 space-y-4">
                            <p class="text-sm">
                                г. Нижний Новгород, <br> Пушкина, 18
                            </p>
<!--                            <p class="text-sm">-->
...
<!--                                </div>-->
                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <h3 class="text-lg font-semibold tracking-wider uppercase">Клиентам:</h3>
                        <div class="mt-4 space-y-4">
                            <div class="flow-root">
...
<!--            </div>-->
            <p class="mt-8 text-base  md:mt-0 md:order-1">
                &copy; "Ремонт ГОСТ" 2015-{year}. Все цены не являются публичной офертой. Все права защищены. Ремонт квартир в Нижнем Новгороде.
