                  ...
                  <div class="rounded-lg shadow-md  ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <div class="pt-5 pb-6">
                      <div class="px-2 space-y-1">
                        <a href="services" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">Услуги</a>

                        <a href="company" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">Компания</a>

                        <a href="gallery" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">Галерея</a>

                        <a href="testimonials" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">Отзывы</a>

                        <a href="specialists" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">Специалисты</a>
