...
const services = [
    ...
    },
    {
        ...
        description: 'Альтернатива натяжным потолкам, когда или нет технической возможности или целесообразности в них. Работы проводятся специальным оборудованием и имеют возможность имитации под натуральные материалы.'
    },
    {
        id: 13,
