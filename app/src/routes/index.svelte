			...
			<div class="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl ">
				<div>
					...
					<p class="mt-5 max-w-prose mx-auto text-xl text-gray-500">
						...
						прямом и переносном смысле. Хотя..... &#129299;
					</p>
				</div>
				<div class="mt-12 ">
				...
				<div class="text-lg  text-gray-500 max-w-prose mx-auto">
					...
					<ul class="text-xl text-gray-500 leading-8">
						...
						<li>
							...
							<a href="https://orbita-stroy.com/">поставщиками строительных и отделочных материалов</a>
							 в Нижнем Новгороде,
							которые обеспечивают своевременную доставку стройматериалов на объект.
						</li>
					</ul>
